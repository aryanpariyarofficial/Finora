...
export const en = {
  ...
  goals: {
    title: "Savings goals",
    subtitle: "Set a target and watch your progress grow.",
    add: "New goal",
    name: "Goal name",
    namePlaceholder: "New bike, Emergency fund…",
    target: "Target amount (Rs.)",
    saved: "Already saved (Rs.)",
    ...
    contributeAmount: "Amount to add (Rs.)",
    add2: "Add",
    added: "Added to goal",
    achieved: "Achieved 🎉",
    of: "of",
  ...
  lock: {
    title: "App lock (PIN)",
    subtitle: "Require a PIN each time Finora opens on this device.",
    enterPin: "Enter your PIN to unlock Finora",
    unlock: "Unlock",
    wrongPin: "Wrong PIN. Try again.",
    newPin: "New PIN",
    confirmPin: "Confirm PIN",
    setPin: "Set PIN",
    pinSet: "App lock enabled",
    pinRemoved: "App lock removed",
    pinActive: "App lock is on for this device.",
...
export const ne: Dict = {
  ...
  goals: {
    title: "बचत लक्ष्य",
    subtitle: "लक्ष्य राख्नुहोस् र प्रगति बढ्दै गएको हेर्नुहोस्।",
    add: "नयाँ लक्ष्य",
    name: "लक्ष्यको नाम",
    namePlaceholder: "नयाँ बाइक, आपत्कालीन कोष…",
    target: "लक्ष्य रकम (रु.)",
    saved: "जम्मा भइसकेको (रु.)",
    targetDate: "लक्ष्य मिति (वैकल्पिक)",
    create: "लक्ष्य बनाउनुहोस्",
    creating: "बन्दैछ…",
    created: "लक्ष्य बनाइयो",
    deleted: "हटाइयो",
    contribute: "पैसा थप्नुहोस्",
    contributeAmount: "थप्ने रकम (रु.)",
    add2: "थप्नुहोस्",
    added: "लक्ष्यमा थपियो",
    achieved: "पूरा भयो 🎉",
    of: "मध्ये",
    left: "बाँकी",
    by: "सम्ममा",
  ...
  lock: {
    title: "एप लक (PIN)",
    subtitle: "यो device मा Finora खोल्दा हरेक पटक PIN माग्ने।",
    enterPin: "Finora खोल्न PIN हाल्नुहोस्",
    unlock: "खोल्नुहोस्",
    wrongPin: "गलत PIN। फेरि प्रयास गर्नुहोस्।",
    newPin: "नयाँ PIN",
    confirmPin: "PIN पुष्टि गर्नुहोस्",
    setPin: "PIN राख्नुहोस्",
    pinSet: "एप लक सक्रिय भयो",
    pinRemoved: "एप लक हटाइयो",
    pinActive: "यो device मा एप लक अन छ।",
    removePin: "PIN हटाउनुहोस्",
    tooShort: "PIN कम्तीमा ४ अंकको हुनुपर्छ।",
    mismatch: "PIN मिलेन।",
  },
  onboard: {
  ...
  loans: {
    ...
    viewSchedule: "पूरा तालिका हेर्नुहोस्",
    scheduleTitle: "किस्ता तालिका",
    startCol: "सुरु मिति",
    endCol: "अन्त्य मिति",
    daysCol: "दिन",
    outstandingCol: "बाँकी रकम",
    totalCol: "किस्ता",
    statusCol: "स्थिति",
    remainingCol: "बाँकी",
    paidStatus: "तिरियो",
    duePassed: "मिति नाघ्यो",
    daysLeft: "दिन बाँकी",
    dueToday: "आज तिर्नुपर्ने",
    exportSchedule: "एक्सपोर्ट",
    back: "ऋणमा फर्कनुहोस्",
  },
  invest: {
    title: "लगानी",
